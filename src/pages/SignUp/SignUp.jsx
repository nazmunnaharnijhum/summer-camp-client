...
const SignUp = () => {
    ...
    createUser(data.email, data.password)
      .then((result) => {
        ...
        .then(() => {
          ...
          fetch('https://summer-camp-school-assignment12-server.vercel.app/users', {
            method: 'POST',
            headers: {
  ...
  return (
    <div className="hero min-h-screen bg-base-200">
      <div className="hero-content flex-col mt-16 lg:flex-row-reverse">
        ...
        <div className="card flex-shrink-0 w-25 h-25 shadow-2xl bg-base-100">
          <form onSubmit={handleSubmit(onSubmit)} className="card-body">
            ...
            <div className="form-control mt-6">
              <input className="btn bg-[#e79e37]" type="submit" value="Sign Up" />
            </div>
          </form>
