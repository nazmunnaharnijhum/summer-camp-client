    ...
    const onSubmit = data => {
        ...
        .then(imgResponse => {
            if(imgResponse.success){
                ...
                const {name, price, instructorName, email, status, availableSeats, enrolledStudents} = data;
                const newClass = {name, price: parseFloat(price), instructorName,email, status,availableSeats, enrolledStudents,image:imgURL}
        ...
        <div className="w-full px-10">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="form-control w-full mb-4">
                    ...
                    <input type="number" placeholder="enrolled Students"
